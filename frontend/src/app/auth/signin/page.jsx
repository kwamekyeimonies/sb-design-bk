...
export default function SignIn() {
    ...
    useEffect(() => {
        if (isSuccess && data) {
            dispatch(authenticate({ token: data?.token, userid: data?.response.id, user_email: data?.response?.email }))
            redirect("/dashboard")
        }
                    ...
                    >
                        ...
                        >
                            <Grid container justifyContent="center" spacing={2}>
                                <Grid item >
                                    <Link href="/auth/signup" variant="body2" sx={{
                                        textDecoration: 'none'
                                    }}>
                                        Sign-Up
                                    </Link>
                                ...
                                <Grid item>
                                    <Link href="./forgotpassword" variant="body2" sx={{
                                        textDecoration: 'none'
